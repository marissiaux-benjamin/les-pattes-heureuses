<x-settings.layout>
    ...
    <x-client.dark-section>
        ...
        <div class="flex flex-wrap">
            ...
            <x-client.animal-card mb="mb-8" image="{{ asset('assets/images/bono.webp') }}" name="Bono" gender="mâle" age="4"
                                  spicies="Chat" breed="Chartreux"/>

            <x-client.animal-card mb="mb-8" image="{{ asset('assets/images/bono.webp') }}" name="Laly" gender="female" age="4"
                                  spicies="Chat" breed="Chartreux"/>

            <x-client.animal-card mb="mb-8" image="{{ asset('assets/images/bono.webp') }}" name="Bruce" gender="mâle" age="4"
                                  spicies="Chat" breed="Chartreux"/>

            <x-client.animal-card mb="mb-8" image="{{ asset('assets/images/bono.webp') }}" name="Marius" gender="mâle" age="4"
                                  spicies="Chat" breed="Chartreux"/>

            <x-client.animal-card image="{{ asset('assets/images/bono.webp') }}" name="Molly" gender="female" age="4"
                                  spicies="Chat" breed="Chartreux"/>
        </div>
