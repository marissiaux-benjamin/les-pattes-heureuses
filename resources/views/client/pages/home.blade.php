<x-settings.layout>
        ...
        <div class="wrapper md:flex md:flex-row-reverse md:items-center">
            <div class="min-w-1/2">
                ...
                <svg width="22" height="29" viewBox="0 0 22 29" fill="none" xmlns="http://www.w3.org/2000/svg"
                     class="ml-[85%] md:ml-0 md:rotate-90 md:-translate-x-[100%] md:-translate-y-[150%]">
    ...
    <x-client.bright-section wrapper="wrapper" pb="pb-20 pt-0"
                             media_query="md:flex md:items-center justify-between items-center">
        ...
        <div>
            ...
            <p class="font-sans line-height-text">
                ...
                compagnons à quatre pattes en attente d’un foyer chaleureux. Notre mission&nbsp;: leur offrir <span
                    class="text-fourth font-medium">sécurité</span>, <span class="text-fourth font-medium">soins</span>
                et
        ...
        <div class="w-full md:min-w-1/2">
            <img src="{{ asset('/assets/images/animals-home-2.webp') }}"
    ...
    <x-client.dark-section wrapper="wrapper" media_query="md:flex md:flex-row-reverse gap-7" pt="pt-15">
        ...
        <img class="hidden min-w-full rounded-2xl md:inline-block md:min-w-1/4" src="{{ asset('/assets/images/personnes_contentes.jpg') }}"
             alt="3 personnes qui mettent le pouce en l'air.">
    ...
    <x-client.dark-section wrapper="wrapper" relative="relative" pt="pt-8 pb-10">
        ...
        <div class="flex md:flex-wrap gap-3 snap-x overflow-scroll mb-12">
