<x-settings.layout>
    <x-client.bright-section wrapper="wrapper">
        ...
        <h1 class="font-serif text main-titles font-black mb-4">
            N’hésitez pas à nous <span class="text-fourth">contacter</span>&nbsp;!
        </h1>
        <p class="text-secondary font-sans line-height-text">
            Vous avez des questions concernant les animaux ou l’adoption&nbsp;? Ou vous voulez peut-être devenir
